...
parser.add_argument('-ii', '--input_images_dir', type=str, default='/home/apumarola/datasets/aeroarms_dataset_processed/pos2/color_selected', help='Input directory of the images to be cropped')
parser.add_argument('-oi', '--output_images_dir', type=str, default='/home/apumarola/datasets/aeroarms_dataset_processed/pos/color_resize', help='Output directory of the images to be cropped')
