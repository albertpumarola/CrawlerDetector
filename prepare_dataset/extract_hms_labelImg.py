...
parser.add_argument('-i', '--input_hms_dir', type=str, default='/home/apumarola/datasets/aeroarms_dataset_processed/pos/labels', help='Input hms directory')
parser.add_argument('-o', '--output_hms_dir', type=str, default='/home/apumarola/datasets/aeroarms_dataset_processed/pos', help='Output hms directory')
