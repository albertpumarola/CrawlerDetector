...
parser.add_argument('-i', '--input_hms_dir', type=str, default='/home/apumarola/datasets/Dataset-CrawlerDetection/selected_hm/pos/hms/', help='Input hms directory')
parser.add_argument('-o', '--output_hms_dir', type=str, default='/home/apumarola/datasets/Dataset-CrawlerDetection/selected_hm/pos/', help='Output hms directory')
